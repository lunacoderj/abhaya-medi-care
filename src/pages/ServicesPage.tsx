      ...
      <section className="py-16 bg-white min-h-[60vh]">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-10 text-center">
             <h2 className="text-3xl font-bold text-brand-charcoal mb-2">All Diagnostic Services</h2>
             <p className="text-brand-gray">Browse our comprehensive list of diagnostic tests and profiles.</p>
          </div>
          <ServicesGrid />
        </div>
      </section>
